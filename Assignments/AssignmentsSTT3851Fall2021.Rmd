...
* Complete [PS-01](https://classroom.github.com/classrooms/87543903-stt3850-fall2021) by 10:00 am Aug 24 --- Final corrections due by 5:00 pm Aug 26 (assignment link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=131169))
...
* Complete the **Data Wrangling** chapter of _Introduction to the Tidyverse_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Aug 24

* Complete the **Data Visualization** chapter of _Introduction to the Tidyverse_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Aug 26
...
* Complete [PS-03](https://classroom.github.com/classrooms/87543903-stt3850-fall2021) by 10:00 am Aug 31 --- Final corrections due by 5:00 pm Sep 2 --- (assignment link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=131169)) 
...
* Complete the **Grouping and Summarizing** chapter of _Introduction to the Tidyverse_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Aug 31

* Complete the **Types of Visualizations** chapter of _Introduction to the Tidyverse_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Sep 2
...
* Complete [PS-02](https://classroom.github.com/classrooms/87543903-stt3850-fall2021) by 10:00 am Sep 7 --- Final corrections due by 5:00 pm Sep 9---(assignment link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=131169)) 
...
* Complete the **Introduction to Modeling** chapter of _Modeling with Data in the Tidyverse_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Sep 7

* Complete the **Modeling with Basic Regression** chapter of _Modeling with Data in the Tidyverse_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Sep 9
...
* Complete the **Modeling with Multiple Regression** chapter of _Modeling with Data in the Tidyverse_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Sep 14

* Complete the **Model Assessment and Selection** chapter of _Modeling with Data in the Tidyverse_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Sep 16
...
* Complete the **Visualizing two variables** chapter of _Correlation and Regression in R_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Sep 28

* Complete the **Correlation** chapter of _Correlation and Regression in R_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Sep 30
...
* Complete [Lab1](https://classroom.github.com/classrooms/53707791-stt3851-fall2020-classroom) by 10:00 am Oct 5---Final corrections due by 5:00 pm Oct 7 --- (assignment link in asulearn)
...
* Complete the **Simple Linear Regression** chapter of _Correlation and Regression in R_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Oct 5

* Complete the **Interpreting Regression Models** chapter of _Correlation and Regression in R_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Oct 5

* Complete the **Model Fit** chapter of _Correlation and Regression in R_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Oct 7
...
* Complete the **Multiple Regression** chapter of _Multiple and Logistic Regression in R_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Oct 14

* Complete the **Evaluating and extending parallel slopes model** chapter of _Multiple and Logistic Regression in R_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Oct 14
...
* Complete [Writing Assignment - Lab2](https://classroom.github.com/classrooms/53707791-stt3851-fall2020-classroom) by 10:00 am Oct 19---Final corrections due by 5:00 pm Oct 21
...
* Complete the **Parallel slopes model** chapter of _Multiple and Logistic Regression in R_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Oct 19

* Complete the **Logistic Regression** chapter of _Multiple and Logistic Regression in R_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Oct 19

* Complete the **Case Study** chapter of _Multiple and Logistic Regression in R_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Oct 21
...
* Complete [Lab3](https://classroom.github.com/classrooms/53707791-stt3851-fall2020-classroom) by 5:00 pm Oct 26 --- Final corrections due by 5:00 pm Oct 28 --- (assignment link in ASULEARN)
...
* Complete the **Regression models: fitting them and evaluating their performance** chapter of _Machine Learning with `caret` in R_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Oct 26

* Complete the **Classification models: fitting them and evaluating their performance** chapter of _Machine Learning with `caret` in R_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Oct 28
...
* Complete the **Tuning model parameters to improve performance** chapter of _Machine Learning with `caret` in R_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Nov 2

* Complete the **Preprocessing your data** chapter of _Machine Learning with `caret` in R_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Nov 2

* Complete the **Selecting models: a case study in churn prediction** chapter of _Machine Learning with `caret` in R_--- [DataCamp](https://www.datacamp.com/enterprise/stt3851-fall2020/assignments) --- Due NLT 5:00 pm Nov 4
...
* Complete [Lab4 - Linear and Nonlinear Modeling](https://classroom.github.com/classrooms/53707791-stt3851-fall2020-classroom) by 10:00 am Nov 9 --- Final corrections due by 5:00 pm Nov 11
...
Work on [kaggle](https://classroom.github.com/classrooms/53707791-stt3851-fall2020-classroom/assignments/kagglepresentation) assignment.
