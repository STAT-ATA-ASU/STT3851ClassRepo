...
Github ClassRoom assignments done to here---time to hit the pool---will update Project one directions this afternoon--- 8/6/19, 10:40
...
* Before class:
    + [Project 1](https://www.tandfonline.com/doi/full/10.1080/10691898.2008.11889569) - Read the hyperlinked paper---Accept assignment from GitHub Classroom - Due Oct 25 - ALAN update directions
...
* Workday
* Due TODAY: Reproduce [Lab: Linear Regression](../Rmarkdown/LabChap3.html) - Accept assignment from GitHub classroom - Due Oct 11

~~**Oct 14:**~~ No Class - Fall Break 

**Oct 16:**

* [Work on Project 1](../Rmarkdown/DirectionsMHP.html)----ALAN update directions ASAP-----Due Oct 25
...
* Homework: [Reproduce _Lab: Cross-Validation_](../Rmarkdown/LabCrossValidation.html) --- Accept assignment from GitHub Classroom - Due Nov 8
...
* Workday
* Due TODAY: [Reproduce _Lab: Cross-Validation_](../Rmarkdown/LabCrossValidation.html) --- Accept assignment from GitHub Classroom - Due Nov 8
* Homework: Data Camp Machine Learning Toolbox - Due Nov 15 
* Homework: Data Camp Machine Learning Toolbox - Accept assignment from Github Classroom Due Nov 22 
...
* Due TODAY: Data Camp Machine Learning Toolbox - Due Nov 15 
...
* Workday
* Due TODAY: Data Camp Machine Learning Toolbox - Accept assignment from Github Classroom Due Nov 22 
