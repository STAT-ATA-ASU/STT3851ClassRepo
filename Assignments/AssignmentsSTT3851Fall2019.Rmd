...
* Homework:
    ...
    + Reproduce [Modified Introduction to R](https://stat-ata-asu.github.io/ISLR-CHAP2-LAB-SC/Lab1-Solution.html).  Accept assignment from GitHub Classroom. Due Aug 30 
...
* Due TODAY:
    + Reproduce [Modified Introduction to R](../Rmarkdown/LabChap2.html).  Accept assignment from GitHub Classroom. Due Aug 30 
    
* Homework:
    + Reproduce [Writing Assignment](../Rmarkdown/WritingAssignment.html).  Accept assignment from GitHub Classroom.  Due Sep 6
...
* Due TODAY:  Reproduce [Writing Assignment](../Rmarkdown/WritingAssignment.html).  Accept assignment from GitHub Classroom.  Due Sep 6
...
* Homework:
    + Data Camp Correlation and Regression - Due Sep 13
    + Data Camp Correlation and Regression - Accept assignment from GitHub Classroom - Due Sep 20
...
* Work Day
* Due TODAY: Data Camp Correlation and Regression - Due Sep 13
* Homework: Data Camp Correlation and Regression - Accept assignment from GitHub Classroom - Due Sep 20
...
* Workday
* Due TODAY: Data Camp Correlation and Regression - Accept assignment from GitHub Classroom - Due Sep 20
...
* Homework: 
    +  Data Camp Multiple and Logistic Regression - Due Sep 27
    +  Data Camp Multiple and Logistic Regression - Accept assignment from GitHub Classroom - Due Oct 4


**Sep 25:**

* Before class:
    + Review pages 82-120 [ISLR](http://www-bcf.usc.edu/~gareth/ISL/ISLR%20Sixth%20Printing.pdf)
...
* Workday
* Due TODAY: Data Camp Multiple and Logistic Regression - Accept assignment from GitHub Classroom - Due Oct 4 
...
* Before class:
    + Review chapter 5 [ISLR](http://www-bcf.usc.edu/~gareth/ISL/ISLR%20Sixth%20Printing.pdf)
